...
class SPAC(RLAlgorithm, Serializable):
    ...
    def __init__(
        ...
        super(SPAC, self).__init__(**base_kwargs)
    ...
    def _init_training(self, env, policy, pool):
        super(SPAC, self)._init_training(env, policy, pool)
    ...
    def log_diagnostics(self, iteration, batch):
        ...
        vf, td_loss = self._sess.run(
            (self._vf_t, self._td_loss_t), feed_dict)
