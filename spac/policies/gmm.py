...
from spac.distributions import GMM
from spac.policies import NNPolicy
from spac.misc import tf_utils
...
class GMMPolicy(NNPolicy, Serializable):
    ...
    def actions_for(self, observations, latents=None,
                    ...
                    with_log_pis=False, with_energy=False, regularize=False):
        ...
        if with_log_pis and with_energy:
            ...
            energies = distribution.energy_t
            return actions, log_pis, energies
